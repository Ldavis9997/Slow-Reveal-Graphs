...
area<- (ggplot(data= vote_data, aes(x= Resident_Number, y= Score, group = vote_type, color= vote_type))+ geom_col(size= .2, width= .8, position= position_dodge(width= .9))+ scale_color_manual(values=pop_colors, guide_legend(label.vjust=2)))
