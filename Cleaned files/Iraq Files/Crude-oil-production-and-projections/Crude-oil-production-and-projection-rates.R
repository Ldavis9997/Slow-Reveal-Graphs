...
theme<- line+theme_classic()+
  ...
  labs(caption= "<p><span style = 'font-size:8.5pt; color:#000000'><sup>a</sup> Assumes pricing dispute with UN is resolved allowing Oil-for-Food exports</p><p><span style = 'font-size:9pt; color:#000000'>to increase and that production from new oilfields gradually comes on line.</span>",
...
ggsave('final1.pdf', height = 4, width =7.5) #If these margins look strange, alter the margins. 
