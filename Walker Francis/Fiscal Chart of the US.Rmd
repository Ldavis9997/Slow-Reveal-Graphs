...
(ggplot(firstbar, aes(x = rev(pop_group), 
  ...
  theme_classic()+
    theme( panel.grid = element_blank(),
           ...
           plot.margin = unit(c(.5,.5,.5,.5), "cm")) + scale_y_continuous(limits= c(0,101), expand=c(0,0)) + scale_x_discrete(expand=c(0,5))) + coord_flip()
dev.off()
img <- image_draw(picture)
 text(340,10, substitute(paste(bold("1. REVENUE"))), family = "Rokkitt", cex = 1.35, col = "black")
