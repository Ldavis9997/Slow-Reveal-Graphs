...
firstbar <- firstbar %>% 
  mutate(vote_type = factor(vote_type, levels = type_levels1),
         pop_group = factor(pop_group, levels = year_levels1),
...
(ggplot(firstbar, aes(x = rev(pop_group), 
                      y = amount, fill=fill, label=''))+
  geom_col(color = "black", size= .3, width=1) + scale_fill_manual(labels= type_levels, values= pop_colors, name = "")+
...
img <- image_draw(picture)
 text(320,10, substitute(paste(bold("1. REVENUE"))), family = "Rokkitt", cex = 1.35, col = "black")
   #plotting y axis labels to the right of the bars
   text(620,747, "411.3", cex = .75, col = "black")+
     text(620,739, "370.9", cex = .75, col = "black")+
     text(620,730, "405.6", cex = .75, col = "black")+
     text(620,720, "489.9", cex = .75, col = "black")+
     text(620,710, "619.6", cex = .75, col = "black")+
     text(620,700, "323.1", cex = .75, col = "black")+
     text(620,691, "262.7", cex = .75, col = "black")+
     text(620,682, "112.1", cex = .75, col = "black")+
     text(620,673, "51.9", cex = .75, col = "black")+
     text(620,664, "41.5", cex = .75, col = "black")+
     text(620,655, "56.1", cex = .75, col = "black")+
     text(620,647, "52.8", cex = .75, col = "black")+
     text(620,639, "46.7", cex = .75, col = "black")+
     text(620,629, "69.0", cex = .75, col = "black")+
     text(620,619, "74.1", cex = .75, col = "black")+
     text(620,611, "65.4", cex = .75, col = "black")+
     text(620,602, "73.8", cex = .75, col = "black")+
     text(620,592, "61.5", cex = .75, col = "black")+
     text(620,584, "49.8", cex = .75, col = "black")+
     text(620,574, "52.6", cex = .75, col = "black")+
     text(620,564, "43.6", cex = .75, col = "black")+
     text(620,555, "30.7", cex = .75, col = "black")+
     text(620,546, "35.7", cex = .75, col = "black")+
     text(620,536, "26.4", cex = .75, col = "black")+
     text(620,527, "29.7", cex = .75, col = "black")+
     text(620,519, "29.9", cex = .75, col = "black")+
     text(620,510, "37.6", cex = .75, col = "black")+
     text(620,502, "20.0", cex = .75, col = "black")+
     text(620,493, "16.9", cex = .75, col = "black")+
     text(620,484, "19.4", cex = .75, col = "black")+
     text(620,475, "30.0", cex = .75, col = "black")+
     text(620,465, "26.3", cex = .75, col = "black")+
     text(620,456, "24.9", cex = .75, col = "black")+
     text(620,447, "50.8", cex = .75, col = "black")+
     text(620,437, "35.4", cex = .75, col = "black")+
     text(620,428, "21.8", cex = .75, col = "black")+
     text(620,418, "33.9", cex = .75, col = "black")+
     text(620,409, "31.9", cex = .75, col = "black")+
     text(620,401, "28.5", cex = .75, col = "black")+
     text(620,391, "24.8", cex = .75, col = "black")+
     text(620,382, "24.8", cex = .75, col = "black")+
     text(620,374, "24.8", cex = .75, col = "black")+
     text(620,365, "23.0", cex = .75, col = "black")+
     text(620,356, "25.3", cex = .75, col = "black")+
     text(620,347, "21.8", cex = .75, col = "black")+
     text(620,338, "19.4", cex = .75, col = "black")+
     text(620,329, "20.5", cex = .75, col = "black")+
     text(620,320, "20.2", cex = .75, col = "black")+
     text(620,311, "14.6", cex = .75, col = "black")+
     text(620,301, "17.8", cex = .75, col = "black")+
     text(620,292, "24.6", cex = .75, col = "black")+
     text(620,283, "21.6", cex = .75, col = "black")+
     text(620,274, "33.1", cex = .75, col = "black")+
     text(620,265, "47.7", cex = .75, col = "black")+
     text(620,254, "15.7", cex = .75, col = "black")+
     text(620,245, "11.2", cex = .75, col = "black")+
     text(620,235, "14.3", cex = .75, col = "black")+
     text(620,225, "9.8", cex = .75, col = "black")+
     text(620,216, "14.4", cex = .75, col = "black")+
     text(620,207, "9.4", cex = .75, col = "black")+
     text(620,199, "7.8", cex = .75, col = "black")+
     text(620,190, "17.1", cex = .75, col = "black")+
     text(620,180, "16.4", cex = .75, col = "black")+
     text(620,170, "15.6", cex = .75, col = "black")+
     text(620,162, "13.6", cex = .75, col = "black")+
     text(620,153, "11.8", cex = .75, col = "black")+
     text(620,144, "11.1", cex = .75, col = "black")+
     text(620,135, "15.0", cex = .75, col = "black")+
     text(620,124, "12.9", cex = .75, col = "black")+
     text(620,115, "10.8", cex = .75, col = "black")+
     text(620,106, "7.5", cex = .75, col = "black")+
     text(620,97, "7.9", cex = .75, col = "black")+
     text(620,89, "8.7", cex = .75, col = "black")+
     text(620,79, "8.4", cex = .75, col = "black")+
     text(620,69, "6.1", cex = .75, col = "black")+
     text(620,59, "5.4", cex = .75, col = "black")+
     text(620,50, "4.7", cex = .75, col = "black")+
     text(620,41, "3.7", cex = .75, col = "black")+
     text(620,30, "4,4", cex = .75, col = "black")+
    
     
     segments(x0=53, x1=53, y0=37, y1=20, lwd = 1, lty = "solid")+
     segments(x0=53, x1=606, y0=20, y1=20, lwd = 1, lty = "solid")+
     segments(x0=606, x1=606, y0=37, y1=20, lwd = 1, lty = "solid")+
     polygon(c(53, 606, 606, 53), c(20, 20, 37, 37), border = "black", col = "#ffe383")
