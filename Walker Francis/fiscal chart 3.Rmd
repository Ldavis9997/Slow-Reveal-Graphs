...
text(19,711, "519.1", cex = .9, col = "black", family = 'Rokkitt')+
  ...
  text(21,393, "24.6", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,384, "25.1", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,375, "25.4", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,366, "22.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,357, "24.1", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,348, "18.6", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,339, "26.8", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,330, "15.3", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,321, "17.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,312, "15.8", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,303, "19.3", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,294, "26.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,285, "28.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,276, "40.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,267, "35.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,258, "32.9", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,249, "34.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,240, "31.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,231, "20.3", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,222, "11.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,213, "13.6", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,204, "14.1", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,195, "17.2", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,186, "12.4", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,177, "16.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,168, "15.6", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,159, "12.8", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,150, "8.0", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,141, "11.6", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,132, "11.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(21,123, "10.8", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,114, "9.3", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,105, "8.4", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,96, "8.8", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,87, "7.5", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,78, "7.3", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,69, "6.1", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,60, "5.7", cex = .9, col = "black", family = 'Rokkitt')+
  text(23,51, "4.3", cex = .9, col = "black", family = 'Rokkitt')+
  
  
  polygon(c(56, 606, 606, 56), c(20, 20, 37, 37), border = "black", col = "#ddd9cb")
