...
text(520,900, "Created for the New York K-12 Social Studies Toolkit by Agate Publishing, Inc., 2015.", cex = 2.2, col = "black")+
  text(305,940, "Adapted from Colin McEvedy and Richard Jones", cex = 2.2, col = "black")+
   text(783,940, substitute(italic("Atlas of World Population History.")), cex = 2.2, col = "black")+
  text(1234,940, "New York: Facts on File, 1978: pp. 342-351.", cex = 2.2, col = "black")+
  text(177,725, "12,000 BCE", cex = 1.9,  srt = 50)+
  text(236,725, "10,000 BCE", cex = 1.9,  srt = 50)+
  text(346,720, "8000 BCE", cex = 1.9,  srt = 50)+
  text(456,720, "6500 BCE", cex = 1.9,  srt = 50)+
  text(560,720, "5000 BCE", cex = 1.9,  srt = 50)+
  text(670,720, "4000 BCE", cex = 1.9,  srt = 50)+
  text(781,720, "3000 BCE", cex = 1.9,  srt = 50)+
  text(885,720, "2000 BCE", cex = 1.9,  srt = 50)+
  text(990,720, "1000 BCE", cex = 1.9,  srt = 50)+
  
  text(575,790, substitute(bold("Time")), cex = 2.1)+
  text(85,370, substitute(bold("Population")), cex = 2.1,  srt = 90)+
