...
segments(x0=50, x1=50, y0=365, y1=360, lwd = 2, lty = "solid")+
  segments(x0=107, x1=107, y0=365, y1=360, lwd = 2, lty = "solid")+
  
  segments(x0=164, x1=164, y0=365, y1=360, lwd = 2, lty = "solid")+
  
  segments(x0=221, x1=221, y0=365, y1=360, lwd = 2, lty = "solid")+
 
  segments(x0=278, x1=278, y0=365, y1=360, lwd = 2, lty = "solid")+
  
  segments(x0=335, x1=335, y0=365, y1=360, lwd = 2, lty = "solid")+
  segments(x0=392, x1=392, y0=365, y1=360, lwd = 2, lty = "solid")+
  
  
  segments(x0=449, x1=449, y0=365, y1=360, lwd = 2, lty = "solid")+
...
picture <- image_graph(width = 1500, height = 1000)
annotation_custom2 <- 
function (grob, xmin = -Inf, xmax = Inf, ymin = -Inf, ymax =Inf, data) 
{
  layer(data = data, stat = StatIdentity, position = PositionIdentity, 
...
grid.raster(plot1, .375, .60, height =.85)
text(520,900, "Created for the New York K-12 Social Studies Toolkit by Agate Publishing, Inc., 2015.", cex = 2.1, col = "black")+
  text(316,940, "Adapted from Colin McEvedy and Richard Jones", cex = 2.1, col = "black")+
   text(783,940, substitute(italic("Atlas of World Population History.")), cex = 2.1, col = "black")+
  text(1223,940, "New York: Facts on File, 1978: pp. 342-351.", cex = 2.1, col = "black")+
  text(136,718, "12,000 BCE", cex = 1.9,  srt = 50)+
  text(236,718, "10,000 BCE", cex = 1.9,  srt = 50)+
  text(346,712, "8000 BCE", cex = 1.9,  srt = 50)+
  text(456,712, "6500 BCE", cex = 1.9,  srt = 50)+
  text(560,712, "5000 BCE", cex = 1.9,  srt = 50)+
  text(670,712, "4000 BCE", cex = 1.9,  srt = 50)+
  text(781,712, "3000 BCE", cex = 1.9,  srt = 50)+
  text(885,712, "2000 BCE", cex = 1.9,  srt = 50)+
  text(990,712, "1000 BCE", cex = 1.9,  srt = 50)+
  
  text(575,790, substitute(bold("Time")), cex = 2)+
  text(40,370, substitute(bold("Population")), cex = 2,  srt = 90)+
  text(575,50, substitute(bold("World Population Growth, 12,000-1,000 BCE")), cex = 2)
