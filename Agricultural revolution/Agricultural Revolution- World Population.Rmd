...
picture <- image_graph(width = 500, height = 450)
annotation_custom2 <- 
...
segments(x0=80, x1=80, y0=365, y1=360, lwd = 2, lty = "solid")+
  ...
  text(66,395, "12,000 BCE", cex = 1,  srt = 50)+
  segments(x0=186, x1=186, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(119,395, "10,000 BCE", cex = 1,  srt = 50)+
  text(172,391, "8000 BCE", cex = 1,  srt = 50)+
  segments(x0=239, x1=239, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(225,391, "6500 BCE", cex = 1,  srt = 50)+
  segments(x0=292, x1=292, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(278,391, "5000 BCE", cex = 1,  srt = 50)+
  segments(x0=345, x1=345, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(331,391, "4000 BCE", cex = 1,  srt = 50)+
  segments(x0=398, x1=398, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(384,391, "3000 BCE", cex = 1,  srt = 50)+
  segments(x0=451, x1=451, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(437,391, "2000 BCE", cex = 1,  srt = 50)+
  segments(x0=503, x1=503, y0=365, y1=360, lwd = 2, lty = "solid")+
  text(489,391, "1000 BCE", cex = 1,  srt = 50)+
  text(290,430, "Time", cex = 1.2)+
  text(15,220, "Population", cex = 1.2,  srt = 90)+
  text(290,45, "World Population Growth, 12,000 - 1,000 BCE", cex = 1.2)
dev.off()
...
grid.raster(plot1, .34, .60, height =.85)
text(497,860, "Created for the New York K-12 Social Studies Toolkit by Agate Publishing, Inc., 2015.", cex = 2.1, col = "black")+
  text(293,900, "Adapted from Colin McEvedy and Richard Jones", cex = 2.1, col = "black")+
   text(760,900, substitute(italic("Atlas of World Population History.")), cex = 2.1, col = "black")+
  text(1200,900, "New York: Facts on File, 1978: pp. 342-351.", cex = 2.1, col = "black")
