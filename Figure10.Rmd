...
pop_colors <- c("#e8c6c0","#9c3a4b","#f97610", "#c58887", "#8b0433")
...
area<- (ggplot(data= vote_data, aes(x= pop_groups, y= amount, group = vote_type, linetype=vote_type))+ geom_line(aes( color=vote_type), size =1)+ geom_point(aes(color= vote_type), size=2.3)+ scale_color_manual(values=pop_colors, guide_legend(label.vjust=5))+ scale_linetype_manual(breaks = types, values=c("dashed", "solid", "dashed", "solid", "dashed"), labels= types)+
 labs(title = "<span style = 'font-size:11pt; color:#000000'><b>Figure 10.</span></p><p><span style = 'font-size:12pt; color:#a21e3c'><b>Reasons for Not Voting: Presidential Elections, 2000-2016</span></p>",
