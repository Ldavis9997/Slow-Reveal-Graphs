...
picture <- image_graph(width = 1500, height = 800)
annotation_custom2 <- 
...
grid.raster(plot1, .19, .37, height =.7)

grid.raster(plot3, .525, .39, height = .7)
grid.raster(plot2, .84, .37, height = .7)
text(1245,210, substitute(bold("3. EXPENDITURES.")), cex = 1.1, col = "black", family = 'Rokkitt1')+
  ...
  segments(x0=735, x1=795, y0=197, y1=197, lwd = 1, lty = "solid")
