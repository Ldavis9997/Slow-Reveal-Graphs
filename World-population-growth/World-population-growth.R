...
segments(x0=50, x1=50, y0=365, y1=360, lwd = 2, lty = "solid")+
  ...
  dev.off()
image_write(img, path = here::here('World-population-growth', "graph.png"), format = "png")



plot1<- image_read(here::here('World-population-growth', "graph.png"))
...
dev.off()
image_write(img, path = here::here('World-population-growth', "final.png"), format = "png")
...
dev.off()
image_write(img, path = here::here('World-population-growth', "1st.png"), format = "png")
...
dev.off()
image_write(img, path = here::here('World-population-growth', "second.png"), format = "png")

###

## FIGURE 3: y-axis and x-axis title UNMASKED
...
dev.off()
image_write(img, path = here::here('World-population-growth', "third.png"), format = "png")
...
dev.off()
image_write(img, path = here::here('World-population-growth', "fourth.png"), format = "png")
