...
pop_colors <- c("#e6cdcb", "#c58887", "#971c3c")


vote_data<- tibble(
  vote_type = rep(types, 11),
  pop_groups= rep(year_levels, c(3,3,3,3,3,3,3,3,3,3,3)),
  amount= c(11,5,10,11,6,11,14,7,15,13,7.5,14.5,22,11,22.5,20,10,21,30,31,30,28,20,29,33,32.7,36,33,27,37,39,37,42), 
...
area<- (ggplot(data= vote_data, aes(x= pop_groups, y= amount, group = vote_type))+ geom_line(aes(color= fill))+ geom_point()+
