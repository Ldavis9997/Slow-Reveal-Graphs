...
area<- (ggplot(data= vote_data, aes(x= pop_groups, y= amount, group = vote_type))+ geom_line(aes(color=vote_type), size =1)+ geom_point()+ scale_color_manual(values=pop_colors)+
