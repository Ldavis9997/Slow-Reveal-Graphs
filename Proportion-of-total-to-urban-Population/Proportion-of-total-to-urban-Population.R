...
library(magick)
# DESCRIPTION:
#  Population of urban to total popultation, by States and Territories - 
...
dev.off()
image_write(img, path = here::here('Proportion-of-total-to-urban-Population', "5th slow reveal.png"), format = "png")
...
dev.off()
image_write(img, path = here::here('Proportion-of-total-to-urban-Population', "1st slow reveal.png"), format = "png")

###

## FIGURE 2: Y-axis UNMASKED
...
dev.off()
image_write(img, path = here::here('Proportion-of-total-to-urban-Population', "2nd slow reveal.png"), format = "png")
...
dev.off()
image_write(img, path = here::here('Proportion-of-total-to-urban-Population', "3rd slow reveal.png"), format = "png")

###

## FIGURE 4: Y-axis title revealed
...
dev.off()
image_write(img, path = here::here('Proportion-of-total-to-urban-Population', "4th slow reveal.png"), format = "png")
