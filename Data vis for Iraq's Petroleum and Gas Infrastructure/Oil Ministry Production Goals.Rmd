...
initial<- (ggplot(data, aes(x= iraq_year, 
  ...
  scale_y_continuous(breaks = c(0,1,2,3,4,5,6), limits= c(0,6), expand= expansion(mult=c(0,.18)))+ scale_fill_manual(labels= type_levels, values= c('#0c0202', '#e2e02a','#d9361c', '#85b838'), name = "")+
  theme_classic()+
...
initial + 
  ...
  annotate(geom="text", x=.88, y=6.1, label="Million b/d",
              color="black", size= 2.8)+coord_cartesian(ylim=c(0,6),clip="off")
