...
area<- (ggplot(iraq_data, 
       aes(x = year, y= value))+
  geom_bar(stat= 'identity', fill= '#37573E', width = .8))+ theme_classic()+ scale_x_discrete(expand= expansion(mult=c(.03,0))) +   scale_y_continuous(breaks = c(0,.5,1,1.5,2,2.5,3,3.5), limits= c(0,3.5), exspand= expansion(mult=c(.15,.3)))+  
  ...
  theme(plot.title.position='plot',
    ...
    plot.title= element_textbox_simple(family= "Open",size = 8, lineheight = 1, 
      width = grid::unit(9, "in"), # fixed width
