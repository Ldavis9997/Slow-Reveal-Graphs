...
#key<- image_read(here::here("Data vis for Iraq's Petroleum and Gas Infrastructure", "Key.png"))
...
#grid.raster(key, .3, .5, height = .1)
text(10, 90, "BOHEMIAN", family = "sans", cex = 5, col = "black")
dev.off()

#save<- image_write(img, path = here::here("Data vis for Iraq's Petroleum and Gas Infrastructure", "Picture1.png"), format = "png")
#save
```

#**your ggplot graph work**
