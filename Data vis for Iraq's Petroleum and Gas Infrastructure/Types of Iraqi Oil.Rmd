...
bp <- ggplot(df, aes(x = "", y = value, fill = type_levels)) +
...
pie<- bp +
         ...
         theme(axis.line=element_blank(),
               ...
               plot.caption= element_markdown(hjust=0)) + scale_fill_manual(values= c("#8fa800", "#e1eb00", "#ed1f02", "#1566ac", "#010102"))
pie
ggsave("pie.pdf")
...
ggplot(df2) + 
  geom_arc_bar(aes(x0 = 0, y0 = 0, r0 = 0, r = 1,
                   start = end, end = start, fill = reorder(type_levels,value)))+
