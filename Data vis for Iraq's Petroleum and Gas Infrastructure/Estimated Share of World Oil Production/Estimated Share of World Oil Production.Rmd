...
img <- image_draw(picture)
 polygon(c(0, 760, 760, 0), c(0, 0, 50, 50), border = "#6D7166", col = "#6D7166")+
     text(98, 28, "STIMATED", family = "Open", cex = 1.8, col = "white")+
   text(35, 26.5, "E", family = "Open", cex = 2.2, col = "white")+
   text(175, 26.5, "S", family = "Open", cex = 2.2, col = "white")+
   text(212, 28, "HARE", family = "Open", cex = 1.8, col = "white")+
   text(271, 28, "OF", family = "Open", cex = 1.8, col = "white")+
   text(311, 26.5, "W", family = "Open", cex = 2.2, col = "white")+
   text(352, 28, "ORLD", family = "Open", cex = 1.8, col = "white")+
   text(402, 26.5, "O", family = "Open", cex = 2.2, col = "white")+
   text(422, 28, "IL", family = "Open", cex = 1.8, col = "white")+
   text(447, 26.5, "P", family = "Open", cex = 2.2, col = "white")+
   text(522, 28, "RODUCTION", family = "Open", cex = 1.8, col = "white")+
...
text(37, 90, substitute(paste(bold('2000'))), family = "Text", cex = 1.3, col = "black")+
   ...
   text(546, 433, "North America,", family = "Text", cex = 1.25, col = "black", pos=4)+
   text(546, 448, "17", family = "Text", cex = 1.25, col = "black", pos=4)+
   ...
   text(665, 290, substitute(paste(bold("Iraq, 4"))), family = "Text", cex = 1.35, col = "red", pos=4)+
...
dev.off()
image_write(img, path = here::here("Data vis for Iraq's Petroleum and Gas Infrastructure", "Estimated Share.png"), format = "png")
