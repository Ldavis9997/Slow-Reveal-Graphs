...
types= c("Less than high school", "High school diploma", "Some college or\nassociate's degree", "Bachelor's degree\nor more")
...
+
 labs(title =  "<span style = 'font-size:10pt; color:#000000'>Figure 8.</span><br><span style = 'font-size:12pt; color:#a21e3c'><b>Composition of American Voters by Age and Educational Detainment: 2016</span>",
       subtitle = "(In Percent)",
       y = "",
       x = "",
