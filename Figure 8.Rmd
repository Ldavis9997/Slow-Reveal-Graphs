...
new3<- (area + theme_classic()+
  theme(
           ...
           legend.text=element_text(margin=margin(r=0,unit="inch")))
+ scale_x_discrete(expand=c(.2,0))
+ scale_y_continuous(expand = expansion(mult = c(0, 0.145))))
new3+annotate("text", x= 3.21, y= 58.8, label= "associate's degree", size= 3.1)+coord_cartesian(ylim=c(0,49.5),clip="off")+annotate("text", x= 3.85, y= 59, label= "or more", size= 3.1)+coord_cartesian(ylim=c(0,49.5),clip="off")
ggsave("new3.png")
```