...
vote_data <- tibble(
  ...
  amount =   c(2.6,1,8.9,87.6,3,1.4,10,85.5,3.6,1.7,9.8,84.9,3.7,1.7,9.9,84.6,
               4.7,2.2,10.6,82.5,5.4,2.4,11.5,80.7,6.0,3.8,11,79.2,7.4,4.2,12.1,76.3,8.4,
               4.9,12.9,73.7,9.2,5.5,11.9,73.3),
  amount_1 =   c(2.6,"",8.9,87.6,3,"","10.0",85.5,3.6,"",9.8,84.9,3.7,"",9.9,84.6,
...
area<- ((ggplot(vote_data, aes(x = pop_group, 
  ...
  geom_col(color = "black", size= .2, width=.7)+ geom_text(size = 4, 
            position = position_stack(vjust = 0.5), color=ifelse(vote_data$vote_type=="Hispanic", 'black', 'white')) + scale_fill_manual(values = pop_colors))+
 labs(title =  "<span style = 'font-size:11pt; color:#000000'><b>Figure 3.</span><br><span style = 'font-size:12pt; color:#a21e3c'><b>Composition of American Voters by Race and Hispanic Origin: Presidential Elections,<br> 1980-2016</span>",
