...
area <- ggplot(vote_data, aes(x = pop_group, y = amount)) +
  ...
  labs(title = "<p><span style = 'font-size:10pt; color:#000000'>Figure 1.</span></p><p><span style = 'font-size:12pt; color:#a21e3c'><b>Voters Among the Total, Citizen, and Registered</p><p><span style = 'font-size:12pt; color:#a21e3c'><b>Voting-Age Population: 2016</span></p>",
