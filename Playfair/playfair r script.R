...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(269,324, substitute(paste(bold("B"))), family = "Playball", cex = 1.8, col = "black", srt=-30)+#change back to arial.
  text(282,331, substitute(paste(bold("A"))), family = "Playball", cex = 1.6, col = "black", srt=-40)+
  text(293,340, substitute(paste(bold("L"))), family = "Playball", cex = 1.4, col = "black", srt=-35)+
  text(305,342, substitute(paste(bold("A"))), family = "Playball", cex = 1.4, col = "black", srt=-15)+
  text(316,344, substitute(paste(bold("N"))), family = "Playball", cex = 1.4, col = "black", srt=-10)+
  text(328,344, substitute(paste(bold("C"))), family = "Playball", cex = 1.4, col = "black", srt=-5)+
  text(342,345, substitute(paste(bold("E"))), family = "Playball", cex = 1.4, col = "black", srt=0)+
  text(357,338, substitute(paste(bold("A"))), family = "Playball", cex = 1.6, col = "black", srt=15)+
  text(368,334, substitute(paste(bold("G"))), family = "Playball", cex = 1.5, col = "black", srt=15)+
  text(378,328, substitute(paste(bold("A"))), family = "Playball", cex = 1.5, col = "black", srt=13)+
  text(386,325, substitute(paste(bold("I"))), family = "Playball", cex = 1.5, col = "black", srt=13)+
  text(394,323, substitute(paste(bold("N"))), family = "Playball", cex = 1.5, col = "black", srt=10)+
  text(405,320, substitute(paste(bold("S"))), family = "Playball", cex = 1.5, col = "black", srt=7)+
  text(418,320, substitute(paste(bold("T"))), family = "Playball", cex = 1.45, col = "black", srt=-7)+
  text(600,211, substitute(paste(bold("BALANCE"))), family = "Playball", cex = 1.4, col = "black", srt=0)+
  text(655,212, substitute(paste(bold("in"))), family = "Playball", cex = 1.2, col = "black", srt=0)+
  text(604,234, substitute(paste(bold("FAVOUR"))), family = "Playball", cex = 1.4, col = "black", srt=0)+
  text(655,236, substitute(paste(bold("of"))), family = "Playball", cex = 1.2, col = "black", srt=0)+
  text(610,256, substitute(paste(bold("E N G L A N D"))), family = "Playball", cex = 1.5, col = "black", srt=0)+#change font
  text(620,320, substitute(paste(bold("Imports"))), family = "Rokkitt", cex = 1.35, col = "black", srt=20)+
  text(578,163, substitute(paste(bold("Exports"))), family = "Playfair", cex = 1.35, col = "black", srt=35)
...
dev.off()
image_write(img, path = here::here("Playfair", "Denmark and Norway Imports.png"), format = "png")
