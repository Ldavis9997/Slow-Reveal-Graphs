...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(217,356, substitute(paste(bold("Line"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-15)+
   text(239,365, substitute(paste(bold("of"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-20)+
  text(270,377, substitute(paste(bold("Exports"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-23)+
