...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(282,331, substitute(paste(bold("A"))), family = "Playfairl", cex = 1.6, col = "black", srt=-40)+
  ...
  text(655,236, substitute(paste(bold("of"))), family = "Playfair", cex = 1.2, col = "black", srt=0)+
