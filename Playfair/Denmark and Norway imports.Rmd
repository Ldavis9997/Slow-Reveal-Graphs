...
font_add(family = "Lora", regular = "Lora-Regular.ttf")

font_files()%>% tibble()%>%filter(str_detect(family, "Lora"))%>%pull(file)
x_label<- c("1700",'','','',"1710",'','')
...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(200,347, substitute(paste(bold("Line"))), family = "Lora", cex = 1.2, col = "black", srt=-20)
