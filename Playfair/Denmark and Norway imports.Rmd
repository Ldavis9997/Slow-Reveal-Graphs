...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(293,340, substitute(paste(bold("L"))), family = "Baskerville", cex = 1.5, col = "black", srt=-35)+
  text(305,342, substitute(paste(bold("A"))), family = "Baskerville", cex = 1.6, col = "black", srt=-20)+
  text(320,344, substitute(paste(bold("N"))), family = "Baskerville", cex = 1.6, col = "black", srt=-10)+
  text(336,344, substitute(paste(bold("C"))), family = "Baskerville", cex = 1.6, col = "black", srt=-5)
