...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(252,35, substitute(paste(bold("Imports"))), family = "Rokkitt", cex = 1.35, col = "black")+
  text(193,35, substitute(paste(bold("and"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(293,35, substitute(paste(bold("to"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(318,35, substitute(paste(bold("and"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(351,35, substitute(paste(bold("from"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(418,35, substitute(paste(bold("DENMARK"))), family = "Rokkitt", cex = 1.65, col = "black")+
  text(478,35, substitute(paste(bold("&"))), family = "Rokkitt", cex = 1.65, col = "black")+
  text(534,35, substitute(paste(bold("NORWAY"))), family = "Rokkitt", cex = 1.65, col = "black")+
  text(596,35, substitute(paste(bold("from"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(631,35, substitute(paste(bold("1700"))), family = "Rokkitt", cex = 1.3, col = "black")+
  text(671,35, substitute(paste(bold("to 1780."))), family = "Rokkitt", cex = 1.3, col = "black")
