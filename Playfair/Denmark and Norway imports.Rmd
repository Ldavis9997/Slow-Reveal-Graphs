...
```{r}
font_add(family = "Baskerville", regular = "LibreBaskerville-Italic.ttf")
font_add(family = "Playball", regular = "Playball-Regular.ttf")
font_add(family = "Rokkitt", regular = "Rokkitt-Regular.ttf")

font_files()%>% tibble()%>%filter(str_detect(family, "Baskerville"))%>%pull(file)
x_label<- c("1700",'','','',"1710",'','')
...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(217,350, substitute(paste(bold("Line"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-10)+
   text(240,359, substitute(paste(bold("of"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-20)+
  text(270,373, substitute(paste(bold("Exports"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-25)+
  text(212,282, substitute(paste(bold("Line"))), family = "Rokkitt", cex = 1.3, col = "black", srt=20)+
  text(237,274, substitute(paste(bold("of"))), family = "Rokkitt", cex = 1.3, col = "black", srt=5)+
  text(272,281, substitute(paste(bold("Imports"))), family = "Rokkitt", cex = 1.3, col = "black", srt=-15)+
  text(269,324, substitute(paste(bold("B"))), family = "Baskerville", cex = 1.8, col = "black", srt=-30)+
  text(282,331, substitute(paste(bold("A"))), family = "Baskerville", cex = 1.6, col = "black", srt=-40)+
  text(293,340, substitute(paste(bold("L"))), family = "Baskerville", cex = 1.4, col = "black", srt=-35)+
  text(305,342, substitute(paste(bold("A"))), family = "Baskerville", cex = 1.4, col = "black", srt=-15)+
  text(316,344, substitute(paste(bold("N"))), family = "Baskerville", cex = 1.4, col = "black", srt=-10)+
  text(328,344, substitute(paste(bold("C"))), family = "Baskerville", cex = 1.4, col = "black", srt=-5)+
  text(342,345, substitute(paste(bold("E"))), family = "Baskerville", cex = 1.4, col = "black", srt=0)+
  text(357,338, substitute(paste(bold("A"))), family = "Baskerville", cex = 1.6, col = "black", srt=15)+
  text(368,334, substitute(paste(bold("G"))), family = "Baskerville", cex = 1.5, col = "black", srt=15)+
  text(378,328, substitute(paste(bold("A"))), family = "Baskerville", cex = 1.5, col = "black", srt=13)+
  text(386,325, substitute(paste(bold("I"))), family = "Baskerville", cex = 1.5, col = "black", srt=13)+
  text(394,323, substitute(paste(bold("N"))), family = "Baskerville", cex = 1.5, col = "black", srt=10)+
  text(405,320, substitute(paste(bold("S"))), family = "Baskerville", cex = 1.5, col = "black", srt=7)+
  text(418,320, substitute(paste(bold("T"))), family = "Baskerville", cex = 1.45, col = "black", srt=-7)+
  text(507,220, substitute(paste(bold("BALANCE"))), family = "Baskerville", cex = 1.5, col = "black", srt=0)
