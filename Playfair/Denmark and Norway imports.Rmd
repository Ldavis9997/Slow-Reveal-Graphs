...
font_files() %>% tibble() %>% filter(str_detect(family, "Vollkorn")) %>% pull(file)
font_add(family = "Vollkorn", regular = "Vollkorn-Italic-VariableFont_wght.ttf")
...
segments(x0=25, x1=25, y0=52, y1=507, lwd = 3, lty = "solid")+
  ...
  text(507,220, substitute(paste(bold("BALANCE"))), family = "Playball", cex = 1.5, col = "black", srt=0)
