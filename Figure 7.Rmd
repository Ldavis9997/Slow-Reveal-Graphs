...
types= c("Less than high school", "High school diploma", str_wrap("Some college or associate's degree", 30), "Bachelor's degree or more")
...
+
 labs(title =  "<span style = 'font-size:11pt; color:#000000'>Figure 7.</span><br><span style = 'font-size:12pt; color:#a21e3c'><b>Composition of American Voters by Educational Detainment and Race<br>and Hispanic Origin: 2016</span>",
       subtitle = "(In Percent)",
       y = "",
       x = "",
...
new2<- (area + theme_classic()+
  theme(
           ...
           plot.subtitle = element_text(size = 10, color = "black", hjust=.05), 
...
new2 + theme(legend.position="top",legend.text=element_text(margin=margin(r=.2,unit="inch")))+guides(fill=guide_legend(title=NULL))
