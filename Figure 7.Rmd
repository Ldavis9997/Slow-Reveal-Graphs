...
new2 + theme(legend.position="top",legend.text=element_text(margin=margin(r=.2,unit="inch")))+guides(fill=guide_legend(title=NULL))+annotate("text", x= 3.19, y= 62.4, label= "associate's degree", size= 3.5)+coord_cartesian(ylim=c(0,49.5),clip="off")+annotate("text", x= 3.88, y= 62.5, label= "or more", size= 3.5)+coord_cartesian(ylim=c(0,49.5),clip="off")
