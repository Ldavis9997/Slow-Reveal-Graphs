...
ggplot(firstbar, aes(x = pop_group, 
  ...
  theme_classic()+
    theme( panel.grid = element_blank(),
           ...
           plot.margin = unit(c(1.5,4.75,0,3), "cm"))+ scale_y_continuous(limits= c(0,101), expand=c(0,0)) + scale_x_discrete(expand=c(0,3)) + coord_flip()
dev.off()
...
text(35,160, "MASS", cex = 2, col = "black", family = 'Rokkitt')+
  ...
  segments(x0=167, x1=167, y0=75, y1=228, lwd = 1, lty = "solid")+
  text(163,60, "10%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=221, x1=221, y0=75, y1=228, lwd = 1, lty = "solid")+
  text(209,60, "20%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=275, x1=275, y0=75, y1=228, lwd = 1, lty = "solid")+
  text(254,60, "30%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=329, x1=329, y0=75, y1=228, lwd = 1, lty = "solid")+
   text(297,60, "40%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=383, x1=383, y0=75, y1=228, lwd = 1, lty = "solid")+
   text(342,60, "50%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=437, x1=437, y0=75, y1=228, lwd = 1, lty = "solid")+
  text(387,60, "60%", cex = 1.5, col = "black", family = 'Rokkitt')+
  segments(x0=491, x1=491, y0=75, y1=145, lwd = 1, lty = "solid")+
